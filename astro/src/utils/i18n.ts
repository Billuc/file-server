...
const TRANSLATIONS: { [l in Lang]: { [k in TranslationKeys]: string } } = {
  en: {
    ...
    [TranslationKeys.CopyContent]: "Copy content",
    [TranslationKeys.CopyURL]: "Copy URL",
    ...
    [TranslationKeys.ShowQR]: "Show QR",
  ...
  fr: {
    ...
    [TranslationKeys.CopyContent]: "Copier le contenu",
    [TranslationKeys.CopyURL]: "Copier le lien",
    ...
    [TranslationKeys.ShowQR]: "Afficher le QRCode",
    [TranslationKeys.TooManyKeyConflicts]:
